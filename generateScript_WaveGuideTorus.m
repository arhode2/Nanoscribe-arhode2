function generateScript_WaveGuideTorus(L, wIn, wOut, rIn, rOut, spaceBetween)
...
%rOut and rIn as inputs in um
%spaceBetween as an input in um
...
vertOffset = 0;
xOffset = 0;
%zMin = 0; defined for torus above, same value for each.
%zMax = 2 * rTor;
