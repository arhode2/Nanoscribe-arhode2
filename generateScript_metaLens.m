function generateScript_metaLens
...
%}
img = imread('RohrschachMOD.png'); %should be input eventually
R = img(:, :, 1);
G = img(:, :, 2);
B = img(:, :, 3);
...
spacing = 0.1;
h = (spacing * dim(1)) - spacing; %um
w = (spacing * dim(2)) - spacing;
d = 20; %should be input eventually.
lp = 0;
lp0 = 25; %input
lp1 = 75; %input
i = 0;
